    ...
    <div className="max-w-5xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div>
        <h1 className="text-3xl font-semibold text-gray-600">
          {product.brandsTitle || "Product Name Not Available"}
        </h1>

        {/* Star Ratings & Reviews */}
        <div className="flex items-center mt-2">
          {Array(
            product.brandsRatingNumber
              ? parseInt(product.brandsRatingNumber)
              : 0
          )
            .fill("")
            .map((_, index) => (
          ...
          <p className="ml-2 text-gray-500">
            {product.brandsRatingNumber}.0 Reviews
          </p>
        </div>
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div>
            <p className="text-gray-500 line-through text-sm">
              RS {product.brandsDiscountPrice ? `${product.brandsDiscountPrice}.00` : "N/A"}
            </p>
            <p className="text-2xl font-semibold text-gray-700">
              RS{" "}
              {product.brandsPrice
                ? `${product.brandsPrice}.00`
                : "Price not available"}
            </p>
          </div>
        ...
        <ul className=" text-gray-700 mt-4">
          {product.brandsDescription  || "Product Description Not Available"}
        </ul>
        ...
        <form ref={formRef} onSubmit={onSubmit} className="space-y-4 mt-4">
          ...
          <input
            type="hidden"
            name="product Title"
            value={product.brandsTitle}
          />
          <input
            type="hidden"
            name="product Price"
            value={product.brandsPrice}
          />
          <input
            type="hidden"
            name="product Image"
            value={product.brandsImage?.url || ""}
          />
